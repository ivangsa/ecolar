...
import { IAccountCategories, AccountCategories } from 'app/shared/model/account-categories.model';
...
describe('Service Tests', () => {
    describe('AccountCategories Service', () => {
        ...
        let elemDefault: IAccountCategories;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(AccountCategoriesService);
        ...
        describe('Service methods', async () => {
            ...
            it('should create a AccountCategories', async () => {
                ...
                service
                    .create(new AccountCategories(null))
                    .pipe(take(1))
