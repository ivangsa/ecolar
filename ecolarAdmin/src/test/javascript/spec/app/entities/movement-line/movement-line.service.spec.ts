...
import { IMovementLine, MovementLine, LineType } from 'app/shared/model/movement-line.model';
...
describe('Service Tests', () => {
    describe('MovementLine Service', () => {
        ...
        let elemDefault: IMovementLine;
        beforeEach(() => {
            TestBed.configureTestingModule({
                imports: [HttpClientTestingModule]
            });
            injector = getTestBed();
            service = injector.get(MovementLineService);
