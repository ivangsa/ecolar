...
import { EcoHealthCheckComponent } from 'app/admin/health/health.component';
import { EcoHealthService } from 'app/admin/health/health.service';

describe('Component Tests', () => {
    describe('EcoHealthCheckComponent', () => {
        let comp: EcoHealthCheckComponent;
        let fixture: ComponentFixture<EcoHealthCheckComponent>;
        let service: EcoHealthService;

        beforeEach(
            async(() => {
                TestBed.configureTestingModule({
                    imports: [EcolarAdminTestModule],
                    declarations: [EcoHealthCheckComponent]
                })
                    .overrideTemplate(EcoHealthCheckComponent, '')
                    .compileComponents();
            })
        );

        beforeEach(() => {
            fixture = TestBed.createComponent(EcoHealthCheckComponent);
            comp = fixture.componentInstance;
            service = fixture.debugElement.injector.get(EcoHealthService);
        });
