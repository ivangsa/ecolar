...
import { EcoLoginModalComponent } from 'app/shared/login/login.component';
...
describe('Component Tests', () => {
    describe('LoginComponent', () => {
        let comp: EcoLoginModalComponent;
        let fixture: ComponentFixture<EcoLoginModalComponent>;
        ...
        beforeEach(async(() => {
            TestBed.configureTestingModule({
                ...
                declarations: [EcoLoginModalComponent],
                providers: [
                    {
                ...
                .overrideTemplate(EcoLoginModalComponent, '')
                .compileComponents();
        }));

        beforeEach(() => {
            fixture = TestBed.createComponent(EcoLoginModalComponent);
