...
export class UserPreferencesResolve implements Resolve<IUserPreferences> {
    ...
    resolve(route: ActivatedRouteSnapshot, state: RouterStateSnapshot) {
        ...
        if (id) {
            return this.service.find(id).pipe(map((userPreferences: HttpResponse<UserPreferences>) => userPreferences.body));
        }
...
export const userPreferencesRoute: Routes = [
    {
        ...
        data: {
            ...
            pageTitle: 'ecolarAdminApp.userPreferences.home.title'
        },
