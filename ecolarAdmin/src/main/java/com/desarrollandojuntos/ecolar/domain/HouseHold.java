...
public class HouseHold implements Serializable {
    ...
    private AccountsDocument accountsDocument = new AccountsDocument();
    ...
    public AccountsDocument getAccountsDocument() {
        return accountsDocument;
    }

    public HouseHold accountsDocument(AccountsDocument accountsDocument) {
        this.accountsDocument = accountsDocument;
        return this;
    }

    public void setAccountsDocument(AccountsDocument accountsDocument) {
        this.accountsDocument = accountsDocument;
    }
