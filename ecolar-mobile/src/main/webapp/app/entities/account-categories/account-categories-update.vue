        ...
        <div class="col-8">
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" >
                ...
                <div v-if="accountCategories">
                    ...
                    <div class="form-group" v-if="accountCategories.id">
                        ...
                        <input type="text" class="form-control" id="id" name="id"
                               v-model="accountCategories.id" readonly />
                    </div>
                ...
                <div>
                    ...
                    <button type="submit" id="save-entity" :disabled="$v.accountCategories.$invalid || isSaving" class="btn btn-primary">
...
<script lang="ts" src="./account-categories-update.component.ts">
</script>
