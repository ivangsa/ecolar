        ...
        <b-collapse is-nav id="header-tabs">
            <b-navbar-nav class="ml-auto">
                ...
                <b-nav-item-dropdown id="admin-menu" v-if="hasAnyAuthority('ROLE_ADMIN')">
                    ...
                    <b-dropdown-item  to="/admin/eco-metrics" v-on:click="collapseNavbar()">
                        <font-awesome-icon icon="tachometer-alt" />
                        <span v-text="$t('global.menu.admin.metrics')">Metrics</span>
                    </b-dropdown-item>
                    <b-dropdown-item to="/admin/eco-health" v-on:click="collapseNavbar()">
                        <font-awesome-icon icon="heart" />
                        <span v-text="$t('global.menu.admin.health')">Health</span>
                    </b-dropdown-item>
                    <b-dropdown-item  to="/admin/eco-configuration" v-on:click="collapseNavbar()">
