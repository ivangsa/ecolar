            ...
            <form name="editForm" role="form" novalidate v-on:submit.prevent="save()" v-if="userAccount">
                ...
                <div>
                    ...
                    <div class="form-group">
                        ...
                        <select class="form-control" multiple name="authority" v-model="userAccount.authorities" v-if="userAccount.authorities">
...
<script lang="ts" src="./UserManagementEdit.component.ts">
</script>
