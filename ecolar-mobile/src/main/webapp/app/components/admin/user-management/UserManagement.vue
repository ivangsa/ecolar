<template>
    <div>
        <h2>
            ...
            <router-link tag="button" class="btn btn-primary float-right jh-create-entity" :to="{name: 'EcoUserCreate'}">
                    ...
                    <tr v-for="user of orderBy(users, propOrder, reverse === true ? 1 : -1)" :id="user.login">
                        ...
                        <td class="text-right">
                            <div class="btn-group flex-btn-group-container">
                                <router-link :to="{name: 'EcoUserView', params: {userId: user.login}}" tag="button" class="btn btn-info btn-sm">
                                    <font-awesome-icon icon="eye"></font-awesome-icon>
                                    <span class="d-none d-md-inline" v-text="$t('entity.action.view')">View</span>
                                </router-link>
                                <router-link :to="{name: 'EcoUserEdit', params: {userId: user.login}}"  tag="button" class="btn btn-primary btn-sm">
