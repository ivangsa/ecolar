...
import MovementLineUpdateComponent from '@/entities/movement-line/movement-line-update.vue';
import MovementLineClass from '@/entities/movement-line/movement-line-update.component';
...
describe('Component Tests', () => {
    describe('MovementLine Management Update Component', () => {
        ...
        beforeEach(() => {
            ...
            wrapper = shallowMount<MovementLineClass>(MovementLineUpdateComponent, {
                store,
                i18n,
                localVue,
                router,
        ...
        describe('save', () => {
            it('Should call update service on save for existing entity', async () => {
                ...
                // THEN
                expect(mockedAxios.put).toHaveBeenCalledWith('api/movement-lines', entity);
            ...
            it('Should call create service on save for new entity', async () => {
                ...
                // THEN
                expect(mockedAxios.post).toHaveBeenCalledWith('api/movement-lines', entity);
                expect(comp.isSaving).toEqual(false);
            });
        });
    });
