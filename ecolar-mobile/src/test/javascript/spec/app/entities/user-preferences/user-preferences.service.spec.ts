...
import { UserPreferences } from '@/shared/model/user-preferences.model';
...
describe('Service Tests', () => {
    describe('UserPreferences Service', () => {
        ...
        beforeEach(() => {
            ...
            elemDefault = new UserPreferences('ID');
        });
        ...
        describe('Service methods', async () => {
            ...
            it('should create a UserPreferences', async () => {
            ...
            it('should update a UserPreferences', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
            ...
            it('should return a list of UserPreferences', async () => {
                const returnedFromService = Object.assign({}, elemDefault);
                const expected = Object.assign({}, returnedFromService);
                mockedAxios.get.mockReturnValue(Promise.resolve([returnedFromService]));
            ...
            it('should delete a UserPreferences', async () => {
