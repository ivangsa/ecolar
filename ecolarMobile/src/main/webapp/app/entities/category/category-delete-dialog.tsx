  ...
  render() {
    ...
    return (
      <Modal isOpen toggle={this.handleClose}>
        ...
        <ModalBody id="ecolarMobileApp.category.delete.question">
          <Translate contentKey="ecolarMobileApp.category.delete.question" interpolate={{ id: categoryEntity.id }}>
        ...
        <ModalFooter>
          ...
          <Button id="eco-confirm-delete-category" color="danger" onClick={this.confirmDelete}>
