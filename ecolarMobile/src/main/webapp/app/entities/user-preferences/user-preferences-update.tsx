...
export interface IUserPreferencesUpdateState {
  isNew: boolean;
  userId: string;
}

export class UserPreferencesUpdate extends React.Component<IUserPreferencesUpdateProps, IUserPreferencesUpdateState> {
  constructor(props) {
    super(props);
    this.state = {
      userId: '0',
  ...
  handleClose = () => {
    this.props.history.push('/entity/user-preferences');
  };
    ...
    return (
      <div>
        <Row className="justify-content-center">
          <Col md="8">
            <h2 id="ecolarMobileApp.userPreferences.home.createOrEditLabel">
              <Translate contentKey="ecolarMobileApp.userPreferences.home.createOrEditLabel">Create or edit a UserPreferences</Translate>
            </h2>
          </Col>
        </Row>
        <Row className="justify-content-center">
              ...
              <AvForm model={isNew ? {} : userPreferencesEntity} onSubmit={this.saveEntity}>
                {!isNew ? (
                  <AvGroup>
                    ...
                    <AvInput id="user-preferences-id" type="text" className="form-control" name="id" required readOnly />
                  </AvGroup>
                ) : null}
                <AvGroup>
                  ...
                  <AvInput id="user-preferences-user" type="select" className="form-control" name="user.id">
                    <option value="" key="0" />
                    {users
                ...
                <Button tag={Link} id="cancel-save" to="/entity/user-preferences" replace color="info">
